...
- Xiaocan startup delay is reduced by rejecting common ad SDK domains seen in proxy logs. Pangolin/CSJ is handled with path-level ad endpoint rewrites instead of broad domain rejects to avoid log retry storms.
